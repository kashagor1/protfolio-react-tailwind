  ...
  return (
    ...
    >
      <div className="w-full lg:w-1/2">
        <ResumeTitle title="Design Skill" subtitle="Features" />

        <div className='className="mt-14 w-full flex flex-col gap-6'>
          <div className="overflow-x-hidden">
            <p className="text-sm uppercase font-medium">Photoshot</p>
            <span className="w-full h-2 bg-black bg-opacity-30 rounded-md inline-flex mt-2">
              <motion.span
      ...
      <div className="w-full lg:w-1/2">
        <ResumeTitle title="Development Skill" subtitle="Features" />
